...
class ArticleController extends Controller
{
    public function index()
    {
        ...
        return view('admin/article/index')->withArticles(Article::where('user_id', Auth::user()->id)->get());
    }
    ...
    public function store(StoreArticlePost $request) // Laravel 的依赖注入系统会自动初始化我们需要的 Request 类
    {
        // 数据验证
